...
class SpringAiChatAdapter(
    ...
    override fun generateResponse(query: String, context: String, history: List<ChatMessage>, sourceHint: String): String {
        val systemPrompt = """
            ...
            STRICT GUIDELINES:
            1. LANGUAGE: Always respond in the SAME language that the user used for their query. If the user asks in Czech, respond in Czech. If in English, respond in English.
